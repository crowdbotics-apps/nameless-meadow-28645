...
## Project Structure
    ...
    ├── nameless_meadow_28645  # Django project configurations
...
1. Clone this repo and `cd nameless_meadow_28645`
...
2. Clone this repo and `cd nameless_meadow_28645`
